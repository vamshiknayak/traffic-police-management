...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 20, 2024 at 10:37 AM
...
(3, '4ai21cs004', 'abhi', '7468028756', 'Chikmagalure'),
(2, '4AI21CS114', 'vamshik k s', '8277011369', 'Mandya'),
...
--
ALTER TABLE `tbllicense`
  MODIFY `Sr_No` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
